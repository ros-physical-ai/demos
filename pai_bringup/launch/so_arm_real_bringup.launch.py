...
def launch_setup(context, *args, **kwargs):
    ...
    # If joint_config_file not explicitly set, resolve from robot_id.
    if not joint_config_file:
        pkg_share = PathJoinSubstitution(
            [FindPackageShare("pai_bringup")]
        ).perform(context)
        candidate = os.path.join(pkg_share, "config", "lerobots", robot_id, "follower.yaml")
        if os.path.isfile(candidate):
            joint_config_file = candidate
...
def generate_launch_description():
    declared_arguments = [
        DeclareLaunchArgument(
            ...
            "from config/lerobots/<robot_id>/. Use 'nominal' for default/CI limits.",
        ),
        DeclareLaunchArgument(
            "usb_port",
        ...
        DeclareLaunchArgument(
            ...
            "Generated by generate_limits.py into config/lerobots/<robot_id>/. "
