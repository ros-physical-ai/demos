...
# Intel XPU detection: prefer explicit opt-in via env var if present, otherwise
# fall back to detection of Intel integrated graphics/NPU hardware or OneAPI runtime.
if [ "${INTEL_XPU=0}" = "1" ]; then
    IS_XPU=true
